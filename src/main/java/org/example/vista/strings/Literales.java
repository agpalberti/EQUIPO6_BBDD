...
public record Literales() {
    public static final String mainMenu = "\nBienvenido a la BBDD del Restaurante. Elija una opción:\n" +
            "1. Crear Tabla\n" +
            "2. Consultar Tabla\n" +
    ...
    public static final String tipoAtributos = "\nIntroduzca los tipos de atributos en el órden introducidos en el paso anterior de la misma manera (VARCHAR(15),INT,BIT...)";
    public static final String clausulaWhere = "\nIntroduzca una clausula where";
